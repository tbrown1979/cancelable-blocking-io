...
lazy val releaseSettings = {
  ...
  Seq(
    ...
    scmInfo := Some(
      ScmInfo(
        url("https://github.com/tbrown1979/cancelable-blocking-io"),
        "git@github.com:tbrown1979/cancelable-blocking-io.git"
      )
    ),
    homepage := Some(url("https://github.com/tbrown1979/cancelable-blocking-io")),
